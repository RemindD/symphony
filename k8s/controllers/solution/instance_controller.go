...
func (r *InstanceReconciler) deploymentBuilder(ctx context.Context, object reconcilers.Reconcilable) (*model.DeploymentSpec, error) {
	...
	solutionName := utils.ReplaceLastSeperator(instance.Spec.Solution, constants.ReferenceSeparator, constants.ResourceSeperator)
...
func (r *InstanceReconciler) handleSolution(ctx context.Context, obj client.Object) []ctrl.Request {
	...
	solutionName := utils.ReplaceLastSeperator(solObj.Name, constants.ResourceSeperator, constants.ReferenceSeparator)
