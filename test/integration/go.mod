...
replace (
	github.com/eclipse-symphony/symphony/api => ../../api
	github.com/eclipse-symphony/symphony/coa => ../../coa
	github.com/eclipse-symphony/symphony/k8s => ../../k8s
	github.com/eclipse-symphony/symphony/packages/mage => ../../packages/mage
	github.com/eclipse-symphony/symphony/packages/testutils => ../../packages/testutils
)
...
require (
	...
	github.com/eclipse-symphony/symphony/packages/testutils v0.0.0-00010101000000-000000000000
